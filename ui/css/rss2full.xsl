   ...
   <xsl:template match="channel">
      ...
      <div id="subscribe-userchoice" style="display:none">
       ...
       <xsl:choose>
        ...
        <xsl:otherwise><a href="http://add.my.yahoo.com/rss?url={$feedUrl}" onclick="this.href = subscribeNow(this.href,'My Yahoo!');return true"><img src="http://us.i1.yimg.com/us.yimg.com/i/us/my/addtomyyahoo4.gif" width="91" height="17" alt="addtomyyahoo4"/></a><br/><a class="img" href="http://feedly.com/#subscription/feed/{$feedUrl}" onclick="this.href = subscribeNow(this.href,'Feedly');return true"><img src="http://s3.feedly.com/feedburner/feedly.png" alt="Subscribe with Feedly"/></a><a class="img" href="http://www.bloglines.com/sub/{$feedUrl}" onclick="this.href=subscribeNow(this.href,'Bloglines');return true"><img src="http://www.bloglines.com/images/sub_modern5.gif" alt="Subscribe with Bloglines"/></a><a href="http://www.netvibes.com/subscribe.php?url={$feedUrl}" onclick="this.href=subscribeNow(this.href,'Netvibes');return true"><img src="http://www.netvibes.com/img/add2netvibes.gif" alt="Add to netvibes"/></a><br/><a class="img" href="https://www.subtome.com/#/subscribe?feeds={$feedUrl}" onclick="this.href = subscribeNow(this.href,'SubToMe');return true"><img src="http://www.subtome.com/subtome-feedburner.png" alt="Subscribe with SubToMe"/></a></xsl:otherwise>
       </xsl:choose>
                     </div>
                     <xsl:if test="true()">
                     <h4>...with other readers:</h4>
                     <form action="https://feedburner.google.com" method="get">
